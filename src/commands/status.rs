...
pub async fn execute(vault: Option<String>) -> Result<()> {
    ...
    println!("{}", "╔══════════════════════════════════════╗".cyan());
    println!("{}", "║         BUNKER VAULT STATUS          ║".cyan().bold());
    println!("{}", "╚══════════════════════════════════════╝".cyan());
    println!();
    ...
    println!("  Created: {}", vault_config.created_at.format("%Y-%m-%d %H:%M"));
    println!("  Modified: {}", vault_config.last_modified.format("%Y-%m-%d %H:%M"));
    println!();
